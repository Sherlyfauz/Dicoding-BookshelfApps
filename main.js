...
read_books = () => {
    for (book of books) {
        ...
        if (book.isComplete) {
            document.getElementById(completeBooks).append(newBook);
        } else {
            document.getElementById(incompleteBooks).append(newBook);
        }
    }
};
//books Filter

filter_books = (keyword) => {
...
addBooks = () => {
    ...
    if (inputBookIsComplete) {
        document.getElementById(completeBooks).append(book);
    } else {
        document.getElementById(incompleteBooks).append(book);
    }
...
booksDeleteAction = (bookId) => {
    ...
    actionDelete.style.color = "green";
...
booksUndoAction = (bookId) => {
    ...
    action.addEventListener("click", function () {
        ...
        const book = createBooks(bookId, bookTitle, bookAuthor, bookYear, false);
        document.getElementById(incompleteBooks).append(book);
...
booksReadAction = (bookId) => {
    ...
    action.addEventListener("click", function () {
        ...
        const book = createBooks(bookId, bookTitle, bookAuthor, bookYear, true);
        document.getElementById(completeBooks).append(book);
